      ...
      {activeTab === 'productCosts' && (
        <EditableTable
          ...
          columns={[
            ...
            { field: 'discount', label: '할인 %', type: 'number', step: '0.01' },
            { field: 'breakEvenPrice', label: '손익 0 가격', type: 'number', step: '0.01' },
            { field: 'maxDiscount', label: '최대 할인 %', type: 'number', step: '0.01' },
